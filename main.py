...
def create_network_graph(n):
    ...
    if os.path.exists(f'data/sequences_df_{n}.pkl'):
        sequences_df = pd.read_pickle(f'data/sequences_df_{n}.pkl')
        shapes_df = pd.read_pickle(f'data/shapes_df_{n}.pkl')
    else:
        sequences_df = get_all_sequence_data(n)
        shapes_df = get_all_shape_data(n)
        sequences_df.to_pickle(f'data/sequences_df_{n}.pkl')
        shapes_df.to_pickle(f'data/shapes_df_{n}.pkl')
    ...
    graph_pickle_path = f'data/graph_{n}.pkl'
